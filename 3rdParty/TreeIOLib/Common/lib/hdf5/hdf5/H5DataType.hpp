...
/// }
///
/// // You have to register the type inside h5
/// h5_REGISTER_TYPE(Position, create_enum_position)
///
...
/// \brief Macro to extend datatype of h5
///
...
///                             {"BAR", FooBar::BAR}});
/// }
/// h5_REGISTER_TYPE(FooBar, create_enum_foobar)
/// \endcode
#define h5_REGISTER_TYPE(type, function) \
    namespace h5 {                       \
    template<>                                 \
