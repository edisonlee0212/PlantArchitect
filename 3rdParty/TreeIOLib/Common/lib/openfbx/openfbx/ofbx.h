...
struct Object
{
    ...
    // Skeleton node:
    double getBoneLength(double defaultValue = 1.0) const;
    double getBoneSize(double defaultValue = 0.0) const;
    Vec3 getBonePosition(const Vec3& defaultValue = { 0.0, 0.0, 0.0 }) const;
